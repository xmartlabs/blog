...
Typically, each time we kick off a project, we have to get the team on the same page as to which artifacts, patterns and conventions to use, which is good for consistency through our team in the way we build apps. 
